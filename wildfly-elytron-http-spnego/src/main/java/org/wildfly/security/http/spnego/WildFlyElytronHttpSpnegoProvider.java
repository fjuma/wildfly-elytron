...
public final class WildFlyElytronHttpSpnegoProvider extends WildFlyElytronBaseProvider {
     ...
     */
    private WildFlyElytronHttpSpnegoProvider() {
        super("WildFlyElytronHttpSpnegoProvider", "1.0", "WildFly Elytron HTTP SPNEGO Provider");
        putService(new ProviderService(this, HTTP_SERVER_FACTORY_TYPE, HttpConstants.SPNEGO_NAME, "org.wildfly.security.http.spnego.SpnegoMechanismFactory", emptyList, emptyMap));
    }
