...
public final class WildFlyElytronHttpDigestProvider extends WildFlyElytronBaseProvider {
    ...
    private WildFlyElytronHttpDigestProvider() {
        ...
        putService(new ProviderService(this, HTTP_SERVER_FACTORY_TYPE, HttpConstants.DIGEST_NAME, "org.wildfly.security.http.digest.DigestMechanismFactory", emptyList, emptyMap));
        putService(new ProviderService(this, HTTP_SERVER_FACTORY_TYPE, HttpConstants.DIGEST_SHA256_NAME, "org.wildfly.security.http.digest.DigestMechanismFactory", emptyList, emptyMap));
        putService(new ProviderService(this, HTTP_SERVER_FACTORY_TYPE, HttpConstants.DIGEST_SHA512_256_NAME, "org.wildfly.security.http.digest.DigestMechanismFactory", emptyList, emptyMap));
