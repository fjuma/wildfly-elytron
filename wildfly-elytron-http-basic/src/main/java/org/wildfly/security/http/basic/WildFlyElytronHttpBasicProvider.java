...
public final class WildFlyElytronHttpBasicProvider extends WildFlyElytronBaseProvider {
     ...
     */
    private WildFlyElytronHttpBasicProvider() {
        super("WildFlyElytronHttpBasicProvider", "1.0", "WildFly Elytron HTTP BASIC Provider");
        putService(new ProviderService(this, HTTP_SERVER_FACTORY_TYPE, HttpConstants.BASIC_NAME, "org.wildfly.security.http.basic.BasicMechanismFactory", emptyList, emptyMap));
    }
