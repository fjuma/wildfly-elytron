...
public class OAuth2SaslClientV11Test extends BaseTestCase {
    ...
    @Test
    public void failedResourceOwnerCredentialsWithMissingClientCredentialsUsingConfiguration() throws Exception {
        SaslClient saslClient = createSaslClientFromConfiguration(URI.create("protocol://test6.org"));
