...
public class IdentityPropagationTest {
    ...
    public void testInflowFromTrustedIdentity() throws Exception {
        SecurityIdentity existingIdentity = getIdentityFromDomain(domain1, "joe");
        SecurityIdentity inflowedIdentity = domain2.inflowFromSecurityIdentity(existingIdentity);
    ...
    public void testInflowFromUntrustedIdentity() throws Exception {
        SecurityIdentity existingIdentity = getIdentityFromDomain(domain1, "sam");
        try {
            SecurityIdentity inflowedIdentity = domain2.inflowFromSecurityIdentity(existingIdentity);
    ...
    public void testUnauthorizedInflowedIdentity() throws Exception {
        SecurityIdentity existingIdentity = getIdentityFromDomain(domain1, "bob");
        try {
            SecurityIdentity inflowedIdentity = domain2.inflowFromSecurityIdentity(existingIdentity);
    ...
    public void testInflowFromAnonymousIdentity() throws Exception {
        SecurityIdentity existingIdentity = domain1.getAnonymousSecurityIdentity();
        SecurityIdentity inflowedIdentity = domain2.inflowFromSecurityIdentity(existingIdentity);
    ...
    public void testInflowFromSameDomain() throws Exception {
        SecurityIdentity existingIdentity = getIdentityFromDomain(domain2, "joe");
        SecurityIdentity inflowedIdentity = domain2.inflowFromSecurityIdentity(existingIdentity);
        assertEquals(existingIdentity, inflowedIdentity);
    }
