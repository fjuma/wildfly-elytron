...
import org.wildfly.security.sasl.util.CertificateCredentialSaslServerFactory;
...
public class SaslServerBuilder {
    ...
    public SaslServer build() throws SaslException {
        ...
        if (certificateCredential != null) {
            factory = new CertificateCredentialSaslServerFactory(factory, certificateCredential);
        }
