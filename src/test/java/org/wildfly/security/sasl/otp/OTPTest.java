...
public class OTPTest extends BaseTestCase {
    ...
    public void testSimpleMD5AuthenticationWithPassPhrase() throws Exception {
        ...
        try {
            ...
            final CallbackHandler cbh = createClientCallbackHandler("userName", "This is a test.", true, algorithm, HEX_RESPONSE);
    ...
    public void testSimpleMD5AuthenticationWithMultiWordOTP() throws Exception {
        ...
        try {
            ...
            final CallbackHandler cbh = createClientCallbackHandler("userName", "BOND FOGY DRAB NE RISE MART", false, algorithm, WORD_RESPONSE);
            final SaslClient saslClient = clientFactory.createSaslClient(new String[] { SaslMechanismInformation.Names.OTP }, null, "test", "testserver1.example.com",
                    Collections.<String, Object>emptyMap(), cbh);
            assertNotNull(saslClient);
            assertTrue(saslClient instanceof OTPSaslClient);
    ...
    public void testSimpleSHA1AuthenticationWithMultiWordOTP() throws Exception {
        ...
        try {
            ...
            final CallbackHandler cbh = createClientCallbackHandler("userName", "GAFF WAIT SKID GIG SKY EYED", false, algorithm, WORD_RESPONSE);
            final SaslClient saslClient = clientFactory.createSaslClient(new String[] { SaslMechanismInformation.Names.OTP }, null, "test", "testserver1.example.com",
                    Collections.<String, Object>emptyMap(), cbh);
            assertNotNull(saslClient);
            assertTrue(saslClient instanceof OTPSaslClient);
    ...
    public void testAuthenticationWithInitHexResponse() throws Exception {
        ...
        try {
            ...
            final CallbackHandler cbh = createClientCallbackHandler("userName", "This is a test.", true, algorithm, INIT_HEX_RESPONSE, "3712dcb4aa5316c1", algorithm, 499, "ke1235");
            final SaslClient saslClient = clientFactory.createSaslClient(new String[]{SaslMechanismInformation.Names.OTP}, null, "test", "testserver1.example.com",
                    Collections.<String, Object>emptyMap(), cbh);
            assertNotNull(saslClient);
            assertTrue(saslClient instanceof OTPSaslClient);
    ...
    public void testAuthenticationWithInitWordResponse() throws Exception {
        ...
        try {
            ...
            final CallbackHandler cbh = createClientCallbackHandler("userName", "This is a test.", true, algorithm, INIT_WORD_RESPONSE, "RED HERD NOW BEAN PA BURG", algorithm, 499, "ke1235");
            final SaslClient saslClient = clientFactory.createSaslClient(new String[]{SaslMechanismInformation.Names.OTP}, null, "test", "testserver1.example.com",
                    Collections.<String, Object>emptyMap(), cbh);
            assertNotNull(saslClient);
            assertTrue(saslClient instanceof OTPSaslClient);
    ...
    public void testAuthenticationWithLowSequenceNumber() throws Exception {
        ...
        try {
            ...
            final CallbackHandler cbh = createClientCallbackHandler("userName", "This is a test.", algorithm, INIT_WORD_RESPONSE, "My new pass phrase");
            final SaslClient saslClient = clientFactory.createSaslClient(new String[]{SaslMechanismInformation.Names.OTP}, null, "test", "testserver1.example.com",
                    Collections.<String, Object>emptyMap(), cbh);
    ...
    public void testAuthenticationWithMultiWordOTPWithAlternateDictionary() throws Exception {
        ...
        try {
            ...
            final CallbackHandler cbh = createClientCallbackHandler("userName", "sars zike zub sahn siar pft", false, algorithm, WORD_RESPONSE);
            final SaslClient saslClient = clientFactory.createSaslClient(new String[] { SaslMechanismInformation.Names.OTP }, null, "test", "testserver1.example.com",
                    props, cbh);
    ...
    public void testAuthenticationWithPassPhraseWithAlternateDictionary() throws Exception {
        ...
        try {
            ...
            final CallbackHandler cbh = createClientCallbackHandler("userName", "This is a test.", true, algorithm, WORD_RESPONSE);
            final SaslClient saslClient = clientFactory.createSaslClient(new String[] { SaslMechanismInformation.Names.OTP }, null, "test", "testserver1.example.com",
                    props, cbh);
    ...
    public void testAuthenticationWithWrongPassword() throws Exception {
        ...
        try {
            ...
            final CallbackHandler cbh = createClientCallbackHandler("userName", "TONE NELL RACY GRIN ROOM GELD", false, algorithm, WORD_RESPONSE); // Wrong password
            final SaslClient saslClient = clientFactory.createSaslClient(new String[] { SaslMechanismInformation.Names.OTP }, null, "test", "testserver1.example.com",
                    Collections.<String, Object>emptyMap(), cbh);
    ...
    public void testAuthenticationWithWrongPasswordInInitResponse() throws Exception {
        ...
        try {
            ...
            final CallbackHandler cbh = createClientCallbackHandler("userName", "GAFF WAIT SKID GIG SKY EYED", false, algorithm, INIT_WORD_RESPONSE, "RED HERD NOW BEAN PA BURG", algorithm, 500, "ke1235");
            final SaslClient saslClient = clientFactory.createSaslClient(new String[]{SaslMechanismInformation.Names.OTP}, null, "test", "testserver1.example.com",
                    Collections.<String, Object>emptyMap(), cbh);
    ...
    public void testAuthenticationWithInvalidNewPasswordInInitResponse() throws Exception {
        ...
        try {
            ...
            final CallbackHandler cbh = createClientCallbackHandler("userName", "BOND FOGY DRAB NE RISE MART", false, algorithm, INIT_WORD_RESPONSE, "RED HERD NOW BEAN PA BURG", algorithm, 499, "ke1235");
            final SaslClient saslClient = clientFactory.createSaslClient(new String[] { SaslMechanismInformation.Names.OTP }, null, "test", "testserver1.example.com",
                    Collections.<String, Object>emptyMap(), cbh);
    ...
    public void testAuthenticationWithInvalidPassPhrase() throws Exception {
        ...
        try {
            ...
            final CallbackHandler cbh = createClientCallbackHandler("userName", "tooShort", true, algorithm, HEX_RESPONSE);
            final SaslClient saslClient = clientFactory.createSaslClient(new String[]{SaslMechanismInformation.Names.OTP}, null, "test", "testserver1.example.com",
                    Collections.<String, Object>emptyMap(), cbh);
    ...
    private CallbackHandler createClientCallbackHandler(String username, String password, boolean usePassPhrase, String algorithm, String responseChoice) throws Exception {
            ...
            context = AuthenticationContext.empty()
                    .with(
                            ...
                            AuthenticationConfiguration.EMPTY
                                    .useName(username)
                                    .useChoice(responseChoice)
                                    .useOneTimePassword(password)
                                    .allowSaslMechanisms(algorithm));
        }
        return ClientUtils.getCallbackHandler(new URI("remote://localhost"), context);
    }

    private CallbackHandler createClientCallbackHandler(String username, String password, boolean usePassPhrase, String algorithm, String responseChoice, String newPassword,
            ...
            context = AuthenticationContext.empty()
                    .with(
                            ...
                            AuthenticationConfiguration.EMPTY
                                    ...
                                    .useChoice(responseChoice)
                                    .usePassPhrase(password)
                                    .useNewOneTimePassword(newAlgorithm, newSequenceNumber, newSeed, newPassword)
                                    .allowSaslMechanisms(algorithm));
        } else {
            context = AuthenticationContext.empty()
                    .with(
    ...
    private CallbackHandler createClientCallbackHandler(String username, String passPhrase, String algorithm, String responseChoice, String newPassPhrase) throws Exception {
        final AuthenticationContext context = AuthenticationContext.empty()
                .with(
                        ...
                        AuthenticationConfiguration.EMPTY
                                ...
                                .useNewPassPhrase(newPassPhrase)
                                .allowSaslMechanisms(algorithm));
