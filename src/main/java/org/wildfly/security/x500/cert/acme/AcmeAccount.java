...
public final class AcmeAccount {
     ...
     *
     * @param resource the ACME resource
    ...
    /**
     * Return whether or not this account has been deactivated.
     *
     * @return {@code true} if this account has been deactivated, {@code false} otherwise
     */
    ...
    /**
     * Set whether or not this account has been deactivated.
     *
     * @param deactivated whether or not this account has been deactivated
     */
