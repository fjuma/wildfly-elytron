...
public class ClientCertAuthenticationMechanism implements HttpServerAuthenticationMechanism {
    ...
    public void evaluateRequest(HttpServerRequest request) throws HttpAuthenticationException {
        ...
        if (securityIdentity != null) {
            final SecurityIdentityEvidence evidence = new SecurityIdentityEvidence(securityIdentity);
            final EvidenceVerifyCallback evidenceVerifyCallback = new EvidenceVerifyCallback(evidence);
            try {
                callbackHandler.handle(new Callback[] { evidenceVerifyCallback });
                if (evidenceVerifyCallback.isVerified()) {
                    final AuthorizeCallback authorizeCallback = new AuthorizeCallback(null, null);
