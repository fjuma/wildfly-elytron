...
/**
 * A {@link SaslServerFactory} which sets the server's credentials using the given key manager.
 *
 * @author <a href="mailto:fjuma@redhat.com">Farah Juma</a>
 */
public final class KeyManagerSaslServerFactory extends AbstractDelegatingSaslServerFactory {
     ...
     */
    public KeyManagerSaslServerFactory(final SaslServerFactory delegate, final X509KeyManager keyManager) {
        super(delegate);
            ...
            while (iterator.hasNext()) {
                ...
                if (callback instanceof CredentialCallback) {
                    ...
                    for (String allowedAlgorithm : allowedAlgorithms) {
                        final String alias = keyManager.chooseServerAlias(allowedAlgorithm, null, null);
                        if (alias != null) {
