        ...
        switch (state) {
            ...
            case ST_PROCESS_RESPONSE: {
                ...
                try {
                    ...
                    final X500Principal clientPrincipal = X509CertificateEvidenceDecoder.getInstance().getPrincipalFromEvidence(evidence);
                    ...
                    clientName = clientPrincipal.getName(X500Principal.CANONICAL);
