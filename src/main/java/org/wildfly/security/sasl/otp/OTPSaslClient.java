    ...
    protected byte[] evaluateMessage(final int state, final byte[] challenge) throws SaslException {
        switch (state) {
            ...
            case ST_CHALLENGE_RESPONSE: {
                ...
                final ExtendedChoiceCallback passwordFormatTypeChoiceCallback = new ExtendedChoiceCallback("One-time password format",
                ...
                PasswordFormat passwordFormat = PasswordFormat.forName(passwordFormatType);
