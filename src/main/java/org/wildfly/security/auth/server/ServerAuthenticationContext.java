...
public final class ServerAuthenticationContext {
    ...
    static String mapAll(String name, MechanismRealmConfiguration mechanismRealmConfiguration, MechanismConfiguration mechanismConfiguration, SecurityDomain domain) {
        ...
        return domain.mapRealmName(name);
    }
