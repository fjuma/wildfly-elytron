 ...
 */
class SetForwardAuthenticationConfiguration extends AuthenticationConfiguration {
    ...
    SetForwardAuthenticationConfiguration(final AuthenticationConfiguration parent, final SecurityDomain sourceDomain, final AccessControlContext context) {
        super(parent.without(SetCallbackHandlerAuthenticationConfiguration.class).without(SetAnonymousAuthenticationConfiguration.class).without(SetNamePrincipalAuthenticationConfiguration.class));
