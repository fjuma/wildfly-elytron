...
public final class WildFlyElytronHttpFormProvider extends WildFlyElytronBaseProvider {
    ...
    private WildFlyElytronHttpFormProvider() {
        ...
        putService(new ProviderService(this, HTTP_SERVER_FACTORY_TYPE, HttpConstants.FORM_NAME, "org.wildfly.security.http.form.FormMechanismFactory", emptyList, emptyMap));
    }
