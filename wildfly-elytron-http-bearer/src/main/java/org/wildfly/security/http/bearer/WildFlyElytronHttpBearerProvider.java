...
public final class WildFlyElytronHttpBearerProvider extends WildFlyElytronBaseProvider {
    ...
    private WildFlyElytronHttpBearerProvider() {
        ...
        putService(new ProviderService(this, HTTP_SERVER_FACTORY_TYPE, HttpConstants.BEARER_TOKEN, "org.wildfly.security.http.bearer.BearerTokenAuthenticationMechanism", emptyList, emptyMap));
    }
