...
public class OidcTest extends AbstractBaseHttpTest {
    ...
    private static final String CLIENT_HOST_NAME = "localhost.localdomain";
    ...
    public static void startTestContainers() throws Exception {
        ...
        client.start(InetAddress.getByName(CLIENT_HOST_NAME), CLIENT_PORT);
        //client.setDispatcher(createAppResponse());
    }
