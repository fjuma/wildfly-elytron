...
public final class WildFlyElytronSaslLocalUserProvider extends WildFlyElytronBaseProvider {
    ...
    private WildFlyElytronSaslLocalUserProvider() {
        ...
        putService(new Service(this, SASL_SERVER_FACTORY_TYPE, SaslMechanismInformation.Names.JBOSS_LOCAL_USER,  "org.wildfly.security.sasl.localuser.LocalUserServerFactory", emptyList, emptyMap));
        putService(new Service(this, SASL_CLIENT_FACTORY_TYPE, SaslMechanismInformation.Names.JBOSS_LOCAL_USER,  "org.wildfly.security.sasl.localuser.LocalUserClientFactory", emptyList, emptyMap));
    }
