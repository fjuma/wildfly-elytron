...
public final class WildFlyElytronHttpClientCertProvider extends WildFlyElytronBaseProvider {
     ...
     */
    private WildFlyElytronHttpClientCertProvider() {
        super("WildFlyElytronHttpClientCertProvider", "1.0", "WildFly Elytron HTTP CLIENT_CERT Provider");
        putService(new ProviderService(this, HTTP_SERVER_FACTORY_TYPE, HttpConstants.CLIENT_CERT_NAME, "org.wildfly.security.http.cert.ClientCertMechanismFactory", emptyList, emptyMap));
    }
